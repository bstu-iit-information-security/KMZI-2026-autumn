...
public:
    explicit GCM(const uint8_t* key) : cipher_(key, 0x1F5) {
...
int main() {
    std::cout << "Cypher: AES-128 | Polinome: 0x1F5 | Optimisation: SWAR GHASH\n\n";

    GaloisField gf(0x1F5);
    ...
    uint8_t ptxt[20] = { 'Z', 'd', 'a', 'r', 'o', 'v', 'd', 'r', ' ',
                       'r', 'u', 'g', '!', '!', '!'};

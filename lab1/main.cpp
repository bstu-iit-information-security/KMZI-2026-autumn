...
void testBitSlicing() {
    ...
    cout << "Тест битовых срезов: "
         << (ok ? "ПРОЙДЕН" : "НЕ ПРОЙДЕН") << '\n';
}
...
int main() {
    ...
    printHex("AES шифротекст", enc, 16);
    ...
    printHex("GCM шифротекст", ct, 16);
    printHex("GCM тег", tag, 16);
